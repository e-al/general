...
beautiful.init("/home/e-al/.config/awesome/themes/zenburn/theme.lua")
...
os.execute("feh  --bg-scale '/home/e-al/images/wallpapers/dark_church.jpg'")
-- Default modkey.
...
-- {{{ Autorun
-- Run a program only if it is not currently running,
...
function add_calendar(inc_offset)
    ...
    calendar = naughty.notify({
        ...
        --text = string.format('<span font_desc="%s">%s</span>', "Andale Mono", os.date("%a, %d %B %Y") .. "\n" .. cal),
